...
<%
    ...
    String sql = "SELECT comment_id, post_id, comment_content, nickname, comment_date FROM posts_comments ORDER BY comment_date DESC";
    ...
    <script>
        ...
        function delete_list(id){
            if(confirm("삭제 하시겠습니까?")){
                location.href="./Delete_Post_Comment.jsp?comment_id=" + id;
            }   
        }
